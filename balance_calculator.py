...
def inbr_stament_maker_packer():
    ...
    Radiobutton(inbr_stament_maker, text = "USD Statement", variable = statement_type,value = 1,fg = fg_color, bg = bg_color,activebackground=mid_color).grid(column=2, row=6, sticky="w")
